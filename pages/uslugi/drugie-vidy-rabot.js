...
import ServicesSix from "../../components/ServicesSix";
...
const UslugiTwoPage = () => {
  ...
  const text_about = {
    title_about: "Другие виды работ",
    img_about: "/assets/images/banner/6.jpg",
  };

  return (
    <Fragment>
      <Helmet>
        <title>Другие виды работ | ООО ЭПИК</title>
      ...
      <MainBanner
        show={() => setShow(true)}
        img="home52" desc="Другие виды работ по&nbsp;запросу"
      />
...
export default withApollo(UslugiTwoPage);
