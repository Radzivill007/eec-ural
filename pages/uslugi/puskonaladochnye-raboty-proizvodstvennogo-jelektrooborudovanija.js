...
const UslugiSixPage = () => {
  ...
  const text_about = {
    title_about: "Пусконаладочные работы производственного электрооборудования",
    img_about: "/assets/images/banner/1.jpg",
  };
  ...
  return (
    <Fragment>
      <Helmet>
        <title>
          Пусконаладочные работы производственного электрооборудования | ООО
          ЭПИК
        </title>
      ...
      <MainBanner
        show={() => setShow(true)}
        img="home48" desc="ПУСКОНАЛАДОЧНЫЕ РАБОТЫ ПРОИЗВОДСТВЕННОГО ЭЛЕКТРООБОРУДОВАНИЯ"
      />
...
export default withApollo(UslugiSixPage);
