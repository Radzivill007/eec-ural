...
const UslugiFourPage = () => {
  ...
  const text_about = {
    title_about: "Наладка и модернизация электрических приводов",
    img_about: "/assets/images/banner/5.jpg",
  };

  return (
    <Fragment>
      <Helmet>
        <title>Наладка и модернизация электрических приводов | ООО ЭПИК</title>
      ...
      <MainBanner
        show={() => setShow(true)}
        img="home51" desc="НАЛАДКА И МОДЕРНИЗАЦИЯ ЭЛЕКТРИЧЕСКИХ ПРИВОДОВ"
      />
...
export default withApollo(UslugiFourPage);
