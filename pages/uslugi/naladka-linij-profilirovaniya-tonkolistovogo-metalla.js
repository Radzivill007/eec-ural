...
const UslugiFivePage = () => {
  ...
  const text_about = {
    title_about: "Наладка линий профилирования тонколистового металла",
    img_about: "/assets/images/banner/4.jpg",
  };
  ...
  return (
    <Fragment>
      <Helmet>
        <title>
          Наладка линий профилирования тонколистового металла | ООО ЭПИК
        </title>
      ...
      <MainBanner
        show={() => setShow(true)}
        img="home50" desc="НАЛАДКА ЛИНИЙ ПРОФИЛИРОВАНИЯ ТОНКОЛИСТОВОГО МЕТАЛЛА"
      />
...
export default withApollo(UslugiFivePage);
