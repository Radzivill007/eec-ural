...
const UslugiOnePage = () => {
  ...
  const text_about = {
    title_about: "Диагностика и устранение неисправностей электротехнических комплексов",
    img_about: "/assets/images/banner/2.jpg",
  };
  ...
  return (
    <Fragment>
      <Helmet>
        <title>
          Диагностика и устранение неисправностей электротехнических комплексов | ООО ЭПИК
        </title>
      ...
      <MainBanner
        show={() => setShow(true)}
        img="home49" desc="ДИАГНОСТИКА И УСТРАНЕНИЕ НЕИСПРАВНОСТЕЙ ЭЛЕКТРОТЕХНИЧЕСКИХ КОМПЛЕКСОВ"
      />
...
export default withApollo(UslugiOnePage);
