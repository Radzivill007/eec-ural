...
//     img: svgPickUp,
//     title: "оперативность",
//     desc: "Быстрый выезд специалиста после обработки заявки. ",
//   },
//   {
//     img: svgApproach,
//     title: "гарантии",
...
const FeatureData = [
  ...
  },
  {
    ...
    desc: "Все наши сотрудники имеют богатый опыт в сфере автоматизации. ",
  },
  {
    img: svgPickUp,
    title: "выезд бесплатно",
    desc: "Быстрый выезд специалиста для диагностики неисправности. ",
  },
  {
    img: svgApproach,
    title: "гарантия 1 год",
    desc: "Гарантия 1 год на все работы \"Под ключ\". Работаем по договору. ",
  },
];
...
const BannerData = [
  {
    no: "1",
    title: "Обработка заявки и бесплатный выезд специалиста",
    desc: "Наши специалисты выявляют потребности клиента, бесплатно выезжают на предприятие и погружаются в процесс производства.",
  },
  {
    no: "2",
    title: "Заключение договора",
    desc: "Анализируется полученная информация и составляется оптимальный план работ для вашего предприятия. После обсуждения плана работ с клиентом подписывается договор.",
  },
  {
    no: "3",
    title: "Выполнение работ",
    desc: "Мы выполняем все работы согласно договору и даем рекомендации по дальнейшей эксплуатации.",
  },
];
